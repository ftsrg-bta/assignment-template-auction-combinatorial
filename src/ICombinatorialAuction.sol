...
interface ICombinatorialAuction {
    ...
    event AuctionStarted(
        uint256[] itemIds, uint256 numItems, uint256 commitmentPhaseEndTime, uint256 revealPhaseEndTime
    );
     ...
     */
    event BidCommitted(address indexed bidder, bytes32 commitmentHash, uint256 depositAmount);
     ...
     */
    event BidRevealed(address indexed bidder, uint256[] itemIds, uint256 bidAmount);
     ...
     * @param totalRevenue Sum of all winning bid amounts
     */
    event AuctionEnded(address[] winningBidders, uint256 totalRevenue);
